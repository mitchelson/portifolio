  ...
  en: {
    translation: {
      ...
      experience: {
        ...
        publicDefender: "Supported the IT department of the state Public Defender's Office, maintaining and enhancing institutional web platforms used by internal teams and the general public. Maintained and updated institutional websites, ensuring content accuracy, uptime and proper functionality for key public-facing services.",
      },
      nav: {
  ...
  pt: {
    translation: {
      ...
      experience: {
        ...
        publicDefender: "Apoiou o departamento de TI da Defensoria Pública do Estado, mantendo e aprimorando plataformas web institucionais usadas por times internos e pelo público geral. Manteve e atualizou sites institucionais, garantindo precisão de conteúdo, uptime e funcionalidade adequada para serviços públicos essenciais.",
      },
      nav: {
